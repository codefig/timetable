...
def arrange(subj_list, curr_time, free_lt,day):
	...
	if(subj_list[subj] >= hall_capacity):
		...
		#check if the student left are negative or positive
		if(subj_list[subj] <= 0):
			del subj_list[subj];
		...
		arrange(subj_list, curr_time, free_lt,day);
...
print "***************",days[0],"****************";
arrange({'agric':1500,'chemistry':1250,'math':2000},0,{'compb':500, 'AST':250},0);